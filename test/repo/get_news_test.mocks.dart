...
// in my_sample_news_app_flutter/test/repo/get_news_test.dart.
...
class _FakeNewsRespone_0 extends _i1.SmartFake implements _i2.NewsRespone {
  _FakeNewsRespone_0(
    Object parent,
...
class MockNewsRepository extends _i1.Mock implements _i3.NewsRepository {
  ...
  @override
  _i4.Future<_i2.NewsRespone> getNews() => (super.noSuchMethod(
        Invocation.method(
          #getNews,
          [],
        ),
        returnValue: _i4.Future<_i2.NewsRespone>.value(_FakeNewsRespone_0(
          this,
          Invocation.method(
            #getNews,
            [],
